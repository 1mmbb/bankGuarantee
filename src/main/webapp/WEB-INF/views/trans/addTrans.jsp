...
<table class="table11" style="width:900px;margin-top:15px;">
  <tr>
    <th colspan="6" style="text-align:center;">选填事务详细信息</th>
  </tr>
  <tr>
    <td align="right">事务明细</td>
    <td><label>
    <input name="tdname" type="text" />
    </label></td>
  ...
  <tr>
    ...
    <td><input name="tdifout" type="text" /></td>
  ...
  <tr>
    ...
    <td colspan="5"><textarea name="tdremarks" cols="100" rows="4"></textarea></td>
  </tr>
  <tr>
